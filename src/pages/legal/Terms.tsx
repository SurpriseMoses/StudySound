  ...
  return (
    <LegalPage
      ...
      sections={[
        ...
        { title: "4. Credits and subscriptions", body: ["Some features cost credits. Credits can be bought as once-off top-ups or received with a monthly plan. Prices and credit costs are shown before you confirm an action.", "Payments are processed by Paystack. Subscriptions renew monthly until cancelled. Credits have no cash value, cannot be transferred, and are non-refundable except where required by the Consumer Protection Act or other law.", "If something you paid credits for fails to generate, contact us through the Support page and we will investigate and make it right."] },
