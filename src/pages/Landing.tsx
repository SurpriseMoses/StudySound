...
const plans = [
  {
    ...
    features: ["10 uploads/month", "120 min AI audio", "50 quiz questions", "Offline storage (5 lessons)", "Multilingual voices"],
    cta: "Start Essential",
    popular: false,
  },
  {
    ...
    features: ["30 uploads/month", "500 min AI audio", "200 quiz questions", "200 visual scenes", "Offline storage (20 lessons)", "Custom study packs"],
    cta: "Start Premium",
    popular: true,
  },
];
